...
Network Load Balancer
    ↓
Traefik Ingress Controller (Private Subnet)
    ↓
...
- `externalTrafficPolicy = Local` is set on the Ingress Traefik `LoadBalancer` service to preserve original client source IP.
